...
@WebFilter(filterName = "LogCostFilter", urlPatterns = {"/*"},
        initParams = {@WebInitParam(name = "ignoredUrl", value = ".ico"),
                      @WebInitParam(name = "filterPath",
                              value = "/HLERP-boot/user/login#/HLERP-boot/user/registerUser#/HLERP-boot/user/randomImage#" +
                                      "/HLERP-boot/platformConfig/getPlatform#/HLERP-boot/v2/api-docs#/HLERP-boot/webjars#" +
                                      "/HLERP-boot/systemConfig/static#/HLERP-boot/systemConfig/static")})
